...
class MyInceptionV3:
    inceptionv3_model_plot_path = 'plots/inceptionv3_model_plot.png'
    ...
    def plot_base_model(self, model):
        print(model.summary())
        plot_model(model, to_file=self.inceptionv3_model_plot_path, show_shapes=True, show_layer_names=True)
